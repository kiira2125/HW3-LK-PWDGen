...
function writePassword() {
  ...
  passwordText.textContent =
      "...removing generated password if you did not write it down you lost lol O_o";
    setTimeout(function () {
      passwordText.textContent = ".. Your Welcome sneakerdoodle lol *_~..";
      setTimeout(function () {
        passwordText.textContent = "";
      }, 1800);
    }, 3500);
...
function getUserSelection() {
  ...
  var numberOfChars = parseInt(
    prompt(
      "How many characters would you like on your password O_o? please select a number between 8 and 25"
    ));
  ...
  if (!useLowerCase && !userUpperCase && !useSpecialCharacters && !useNumbers) {
    alert(
      " Hi there! You need to select a minmum of one character type, please O_o!"
    );
    return;
  }
